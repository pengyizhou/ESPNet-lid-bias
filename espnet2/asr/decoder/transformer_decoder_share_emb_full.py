...
class BaseTransformerDecoder(AbsDecoder, BatchScorerInterface):
    ...
    def forward(
        ...
        x_asr, tgt_mask_asr, memory_asr, memory_mask_asr = self.decoders_asr(x, tgt_mask_sub, memory, memory_mask)
    ...
    def batch_score(
        ...
        logp, states = self.forward_one_step(x, ys_mask, xs, cache=batch_state)
