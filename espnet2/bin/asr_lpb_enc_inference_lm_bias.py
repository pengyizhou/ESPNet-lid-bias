...
from espnet2.tasks.asr_lpb_enc_lm_bias import ASRTask
...
from espnet.nets.batch_beam_search_lm_bias import BatchBeamSearch
from espnet.nets.batch_beam_search_online_sim import BatchBeamSearchOnlineSim
from espnet.nets.beam_search_lm_bias import BeamSearch, Hypothesis
...
class Speech2Text:
    ...
    def __init__(
        ...
        token_lid_list = asr_model.token_lid_list
        scorers.update(
            decoder=decoder,
            ctc=ctc,
    ...
    def __call__(
        ...
        for hyp in nbest_hyps:
            if not isinstance(hyp, (Hypothesis, TransHypothesis)):
                logging.info(f"Not a hyp {hyp}")
        for hyp in nbest_hyps:
...
def get_parser():
    ...
    group.add_argument("--lm_weight", type=float, default=0.2, help="RNNLM weight")
    ...
    group.add_argument(
        ...
        type=int,
        default=2636,
        help="The First English token id in tokens.txt",
    )
    group.add_argument(
        "--bpemodel",
        type=str_or_none,
